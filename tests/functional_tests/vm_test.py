...
from lib.vm import VM, ARCH  # noqa: E402

NIXOS_DIR = str(Path(__file__).resolve().parent.parent.parent)

INSTALL_SCRIPT = """\
import sys
sys.path.insert(0, "/etc/nixos")
from bin.install import Installer

...
class Installer:
    ...
    @classmethod
    def get_plain_text_password_path(cls): return Config.eval("config.settings.disk.encryption.plainTextPasswordFile") if Config.eval("config.settings.disk.encryption.enabled") == "true" else None
    @classmethod

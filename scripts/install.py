...
def main():
    ...
    if Installer.sh.exists(Config.get_secrets_path(), Installer.get_plain_text_password_path()): Utils.print(f"Found {Config.get_secrets_path()} and {Installer.get_plain_text_password_path()}")

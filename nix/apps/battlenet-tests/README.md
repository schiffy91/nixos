...
lives in `nix/apps/battlenet.nix`; the Proton compat-tool source and
packaging live in `nix/apps/pkg-overrides/proton-custom`.
...
That wrapper is defined by `nix/apps/battlenet.nix`.
